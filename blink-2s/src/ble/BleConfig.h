...
// ─── Advertising ──────────────────────────────────────────────────────────────
#define BLE_ADV_PAIRING_INTERVAL 320 // 200ms  (unidade: 0.625ms)
#define BLE_ADV_FAST_INTERVAL 320    // 200ms  (unidade: 0.625ms)
#define BLE_ADV_MIDDLE_INTERVAL 800  // 500ms
#define BLE_ADV_SLOW_INTERVAL 1600   // 1s
...
#define CMD_BUZZ 0x01 // [0x01, hi_ms, lo_ms, 0x00]
#define CMD_LOST 0x02 // [0x02, 0x00, 0x00, 0x00]

#define BLE_COMPANION_TIMEOUT_MS (5 * 60 * 1000)
